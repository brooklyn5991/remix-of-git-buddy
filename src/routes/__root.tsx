...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Garen's Garden" },
      {
        property: "og:description",
        content:
          "Obiaruku's finest bed & breakfast. Reborn 2026. Complimentary breakfast, 24/7 solar power, secure premises, and warm, personalized hospitality.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Garen's Garden" },
      { property: "og:url", content: "https://garensgarden.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Garen's Garden" },
      { name: "twitter:description", content: "Obiaruku's finest bed & breakfast. Reborn 2026. Complimentary breakfast, 24/7 solar power, secure premises, and warm, personalized hospitality." },
      { property: "og:image", content: "https://garensgarden.lovable.app/og-image.jpg?v=2" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://garensgarden.lovable.app/og-image.jpg?v=2" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/favicon.png?v=2", type: "image/png" },
      { rel: "manifest", href: "/manifest.webmanifest" },
      { rel: "apple-touch-icon", href: "/app-icon-512.png?v=2" },
